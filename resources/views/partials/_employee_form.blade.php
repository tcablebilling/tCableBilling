    ...
    <div class="item form-group">
        ...
        <div class="col-md-6 col-sm-6 col-xs-12">
           {!! Form::text('father_name', null,['class'=>'form-control col-md-7 col-xs-12', 'required'=>'required', 'placeholder'=>'both name(s) e.g Jon Doe']);!!}
        </div>
    </div>    
    <div class="item form-group">
    ...
    <div class="item form-group">
        ...
        <div class="col-md-6 col-sm-6 col-xs-12">
           {!! Form::text('spouse_name', null,['class'=>'form-control col-md-7 col-xs-12', 'required'=>'required', 'placeholder'=>'both name(s) e.g Jon Doe']);!!}
        </div>
    </div>
    <div class="item form-group">
        {!! Form::label('present_address', 'Present Address *', array('class' => 'control-label col-md-3 col-sm-3 col-xs-12'));!!}
        <div class="col-md-6 col-sm-6 col-xs-12">
           {!! Form::textarea('present_address', null,['class'=>'form-control col-md-7 col-xs-12', 'required'=>'required', 'data-validate-minmax'=>'10,100', 'rows'=>'5', 'placeholder'=>'Enter address here...']);!!}
        </div>
    </div>
    <div class="item form-group">
        {!! Form::label('permanent_address', 'Permanent Address *', array('class' => 'control-label col-md-3 col-sm-3 col-xs-12'));!!}
        <div class="col-md-6 col-sm-6 col-xs-12">
           {!! Form::textarea('permanent_address', null,['class'=>'form-control col-md-7 col-xs-12', 'required'=>'required', 'data-validate-minmax'=>'10,100', 'rows'=>'5', 'placeholder'=>'Enter address here...']);!!}
        </div>
    </div>
    <div class="item form-group">
        {!! Form::label('phone_personal', 'Phone No. (Personal)', array('class' => 'control-label col-md-3 col-sm-3 col-xs-12'));!!}
        <div class="col-md-6 col-sm-6 col-xs-12">
           {!! Form::text('phone_personal', null,['class'=>'form-control col-md-7 col-xs-12', 'required'=>'required', 'placeholder'=>'Enter primary phone number...']);!!}
        </div>
    </div>
    ...
    <div class="item form-group">
        ...
        <div class="col-md-6 col-sm-6 col-xs-12">
           {!! Form::text('phone_home', null,['class'=>'form-control col-md-7 col-xs-12', 'required'=>'required', 'placeholder'=>'Enter alternative phone number...']);!!}
        </div>
    </div>
    <div class="item form-group">
        {!! Form::label('voter_id', 'Voter ID Card No. *', array('class' => 'control-label col-md-3 col-sm-3 col-xs-12'));!!}
        <div class="col-md-6 col-sm-6 col-xs-12">
           {!! Form::text('voter_id', null,['class'=>'form-control col-md-7 col-xs-12', 'required'=>'required', 'placeholder'=>'Enter address proof number...']);!!}
        </div>
    </div>
    <div class="item form-group">
        {!! Form::label('post', 'Post *', array('class' => 'control-label col-md-3 col-sm-3 col-xs-12'));!!}
        <div class="col-md-6 col-sm-6 col-xs-12">
           {!! Form::text('post', null,['class'=>'form-control col-md-7 col-xs-12', 'required'=>'required', 'placeholder'=>'Enter address proof number...']);!!}
        </div>
    </div>
    <div class="item form-group">
        {!! Form::label('salary', 'Salary *', array('class' => 'control-label col-md-3 col-sm-3 col-xs-12'));!!}
        <div class="col-md-6 col-sm-6 col-xs-12">
           {!! Form::number('salary', null,['class'=>'form-control col-md-7 col-xs-12', 'required'=>'required', 'placeholder'=>'Enter address proof number...']);!!}
        </div>
    </div>
